...
<html lang="en">
  ...
  <body class="starter-template" data-spy = "scroll">
				...
				<li class="dropdown">
					<a href="#" data-toggle="dropdown" class="dropdown-toggle">My Account<b class="caret"></b></a>
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="questionaire">Questionnaire</a></li>
						</ul>
				</li>
	...
	<section id="questionpage" class="section lightgray">
	...
	<section id="assess" class="section lightgray" style="display: none; padding-top: 100px;">
		<div class="container-fluid fullscreen">
			<div class="row">
				<div class="col-xs-12">
					<p>Thanks for completing the questionnaire.</p>
					<p>From your answers, we have made the following assessment.</p>
