        ...
        if(lz_chat_data.InputFieldValues[i].Active || (findex == 116 && lz_session.OVLWMSElem == "phone"))
        {
            try
            {
                if(lz_chat_data.InputFieldValues[i].Type == "File")
                    ...
                    isFilled = (lz_chat_data.InputFieldValues[i].Type == "CheckBox") ? document.getElementsByName("form_" + findex)[0].checked : lz_chat_get_input_value(findex).length > 0;
...
function lz_chat_change_group(_box){
    ...
    OverlayChatWidgetV2.__CurrentGroup = lz_chat_data.Groups.GetGroupById(_box.value);
        ...
        while(OverlayChatWidgetV2.__CurrentGroup == null)
        {
            ...
            if(position == _box.childNodes.length)
                if(!reset)
                {
                    ...
                    break;
            OverlayChatWidgetV2.__CurrentGroup = lz_chat_data.Groups.GetGroupById(_box.childNodes[position].value);
        }
    }
...
OverlayChatWidgetV2.UpdateFormUI = function(){
    try
    {
        if(lz_chat_data.InputFieldIndices != null && OverlayChatWidgetV2.__CurrentGroup != null)
        {
            if(lz_first_call)
            {
                lz_chat_loading(false);
            ...
            for(var i = 0;i < lz_chat_data.InputFieldIndices.length;i++)
            {
                ...
                try
                {
                    ...
                    if(document.getElementById("lz_form_active_" + findex).value == "true" || (lz_session.OVLWMSElem=="phone" && findex == 116))
                    {
                        ...
                        document.getElementsByName("form_" + findex)[0].disabled = OverlayChatWidgetV2.__ModeChangeDetails && lz_chat_data.InputFieldValues[i].Validation;
                    }
                    else
            ...
            if(OverlayChatWidgetV2.__CurrentGroup != null)
            {
                ...
                if(tosText.length)
                {
                    ...
                    document.getElementById("lz_chat_tos_text").innerHTML = document.getElementById("lz_chat_tos_text").innerHTML.replace('<a>','<a href="#" onclick="OverlayChatWidgetV2.ToggleTOS(true);">');
                }
            }
...
OverlayChatWidgetV2.SetUIGroup = function(_groupId,_set){
    if(lz_chat_data.Groups != null)
    {
        ...
        var setGroup = lz_chat_data.Groups.GetGroupById(lz_global_base64_url_decode(_groupId));
        if(setGroup != null)
        {
            OverlayChatWidgetV2.__CurrentGroup = lz_chat_data.Groups.GetGroupById(lz_global_base64_url_decode(_groupId));
            lz_chat_data.Groups.SelectGroupById(OverlayChatWidgetV2.__CurrentGroup.Id,document.getElementById("lz_form_groups"));
            OverlayChatWidgetV2.SetGroupInfo();
        }
        OverlayChatWidgetV2.UpdateChatFunctions();
    }
...
OverlayChatWidgetV2.SetMode = function(_type,_click){
    ...
    {
        OverlayChatWidgetV2.ToggleFeedback(false);
        return;
    }
...
OverlayChatWidgetV2.UpdateUI = function(){
    ...
    if(OverlayChatWidgetV2.__FormVisible && !inChat && lz_session.OVLWMSElem == 'chat' && lz_chat_data.InputFieldIndices != null && lz_session.OVLWMState=='1')
...
OverlayChatWidgetV2.ToggleFeedback = function(_visible){
    if(_visible)
    {
