...
<head>
    ...
    <script type="text/javascript" src="./templates/jscriptv22/kb.min.js"></script>
    <script type="text/javascript" src="./templates/jscriptv22/icons.min.js"></script>
    <script type="text/javascript" src="./templates/jscriptv22/jsglobal.min.js"></script>
</head>
<body onload="init();">
    <div id="lz_kb_main">
