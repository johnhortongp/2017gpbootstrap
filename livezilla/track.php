...
else
{
	...
	if(VisitorMonitoring::$Visitor->FirstCall && !VisitorMonitoring::$Browser->GetFirstCall())
        exit("window.name='';lz_tracking_stop_tracking(4426);");
	...
	else
	{
        ...
        if(VisitorMonitoring::$CreateUserObject)
        {
            ...
            if(VisitorMonitoring::$CreateUserObject && !empty($currentURL) && (count(VisitorMonitoring::$Browser->History) == 0 || (count(VisitorMonitoring::$Browser->History) > 0 && VisitorMonitoring::$Browser->History[count(VisitorMonitoring::$Browser->History)-1]->Url->GetAbsoluteUrl() != $currentURL->Url->GetAbsoluteUrl())))
            {
