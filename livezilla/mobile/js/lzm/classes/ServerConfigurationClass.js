    ...
    this.m_Settings = [
        ...
        {name:'Server', title: tid('server'), icon:'server', groups: [
            {name: 'Misc', title: tid('advanced'), controls: [
                ...
                {name:'gl_url', standard:true, type:'string', title: tidc('server_url') + ' <span class="text-gray">('+tidc('example',': ') + DataEngine.getServerUrl('') + ')</span>', top:'double', value: ''},
                {name:'gl_url_detect', standard:true, type:'bool', title: tid('detect_url'), top:'half', value: true},

                {name:'gl_lzid', standard:true, type:'string', value: '', top: 'double', title: tidc('server_id')},
