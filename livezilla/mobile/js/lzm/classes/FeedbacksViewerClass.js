...
FeedbacksViewer.prototype.GetFeedbackLine = function(fb,_elementId) {
    ...
    var onclickAction = ((!IFManager.IsAppFrame && !IFManager.IsMobileOS) || IFManager.IsDesktopApp()) ? ' onclick="FeedbacksViewer.Select(event, \'' + fb.i + lineExt + '\');"' : ' onclick="FeedbacksViewer.Select(event, \'' + fb.i + lineExt + '\');FeedbacksViewer.ShowContextMenu(event);"';
    var onconetxtMenuAction = ((!IFManager.IsAppFrame && !IFManager.IsMobileOS) || IFManager.IsDesktopApp()) ? ' oncontextmenu="FeedbacksViewer.Select(event, \'' + fb.i + lineExt + '\');FeedbacksViewer.ShowContextMenu(event);"' : '';
    ...
    var fbhtml = '<tr id="feedbacks-list-line-'+fb.i+lineExt+'" '+onclickAction+onconetxtMenuAction+ondblclickAction+' class="feedbacks-list-line'+selectedLine+'">' +
