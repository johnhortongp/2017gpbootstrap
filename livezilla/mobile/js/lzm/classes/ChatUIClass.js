...
ChatUI.prototype.CreateChatsHtml = function(){
    ...
    if(lzm_chatDisplay.IsFullscreenMode()){
        ...
        bodyHtml +=  '<thead><tr><th style="padding:0;"></th><th style="padding:0;"></th>';
...
ChatUI.prototype.GetIconField = function(_chat,_missed,_closed,_bot){
    ...
    var color = (_missed) ? '' : ' style="color:'+iconFieldData[3]+' !important;"';
    return '<td id="allchats-icon-' + _chat.i + '"'+iconFieldData[0]+iconFieldData[1]+'><i class="fa fa-'+iconFieldData[2]+'"'+iconFieldData[3]+color+'></i></td>';
};
