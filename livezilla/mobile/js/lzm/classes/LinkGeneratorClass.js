...
LinkGeneratorClass.prototype.CreateSelectElementTypeHtml = function() {
    ...
    //contentHtml += '<div class="top-space left-space-child'+((this.isTypeSelected('no-tracking')) ? ' ui-disabled' : '')+'"><input id="element-no-tracking" value="no-tracking" name="element-type" type="radio" class="radio-custom element-type" /><label for="element-no-tracking" class="radio-custom-label">' + tid('no-tracking') + '</label></div>';
